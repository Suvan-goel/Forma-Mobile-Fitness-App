...
const EXERCISE_INTERPRETATION_PROFILES: Record<string, ExerciseReliabilityInterpretationProfile> = {
  ...
  pushup: {
    ...
    cueFamilies: [
      ...
      { family: 'torsoMotion', requiredChains: ['torso'] },
  ...
  barbellsquat: {
    ...
    cueFamilies: [
      ...
      { family: 'torsoControl', requiredChains: ['torso'] },
      { family: 'lowerBodyTracking', requiredChains: ['leftLeg', 'rightLeg'] },
      { family: 'footAnklePosition', requiredChains: ['leftLeg', 'rightLeg'] },
    ],
  },
};
