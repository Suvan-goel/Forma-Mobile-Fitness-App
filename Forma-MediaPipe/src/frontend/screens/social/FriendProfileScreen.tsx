...
export const FriendProfileScreen: React.FC = memo(() => {
    ...
    return (
      <View style={[styles.container, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          <TouchableOpacity onPress={() => navigation.goBack()} style={styles.headerIcon} activeOpacity={0.7}>
  ...
  const estimatedXp = Math.round((profile.totalWorkouts * Math.max(profile.avgFormScore, 1)) / 1.5);
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={handleCompare} style={styles.headerIcon} activeOpacity={0.7}>
      ...
      >
        <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
            ...
            <View style={styles.nameBlock}>
              ...
              <View style={styles.actionRow}>
                <TouchableOpacity activeOpacity={0.75} onPress={handleFollow}>
                  <LinearGradient
                    colors={isCurrentlyFollowing ? ['#252B31', '#171B20'] : ['#8D67FF', '#5A38D6']}
                  ...
                  >
                    ...
                    <Text style={[styles.actionText, isCurrentlyFollowing && styles.actionTextMuted]}>
                      {isCurrentlyFollowing ? 'Following' : 'Follow'}
                    </Text>
                  </LinearGradient>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={0.75} onPress={handleCompare}>
                  <View style={styles.comparePill}>
                    <GitCompare size={12} color={COLORS.primary} />
          ...
          <View style={styles.statStrip}>
            <StatBlock value={profile.totalWorkouts || 0} label="Total Workouts" />
            <View style={styles.statDivider} />
            <StatBlock value={profile.streakDays || 0} label="Week Streak" prefix={<Flame size={13} color={COLORS.yellow} fill={COLORS.yellow} />} />
            <View style={styles.statDivider} />
            <StatBlock value={Math.round(profile.avgFormScore) || 0} label="Avg Form Score" />
          </View>

          <ProfileCard>
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>Level & Rewards</Text>
              <TouchableOpacity onPress={handleCompare} activeOpacity={0.75}>
            ...
            <Text style={styles.xpText}>{estimatedXp.toLocaleString()} / {LEVEL_TARGET.toLocaleString()} XP</Text>
          </ProfileCard>

          <ProfileCard>
            <Text style={styles.sectionTitle}>Badges</Text>
            <View style={styles.badgeRow}>
              {(profile.earnedBadgeIds.length > 0 ? profile.earnedBadgeIds : ['1', '2', '3', '4']).slice(0, 4).map((badgeId, index) => (
                <View key={badgeId} style={styles.badgeShell}>
                  <LinearGradient
                    colors={profile.earnedBadgeIds.includes(badgeId) ? ['#3C4651', '#1A222C'] : ['#272D34', '#161A1F']}
